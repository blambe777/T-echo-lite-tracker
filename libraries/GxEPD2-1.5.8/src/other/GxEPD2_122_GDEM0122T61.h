#ifndef _GxEPD2_122_GDEM0122T61_H_
#define _GxEPD2_122_GDEM0122T61_H_

#include "../GxEPD2_EPD.h"

class GxEPD2_122_GDEM0122T61 : public GxEPD2_EPD
{
  public:
    // attributes
    static const uint16_t WIDTH = 176;
    static const uint16_t WIDTH_VISIBLE = WIDTH;
    static const uint16_t HEIGHT = 192;
    ...
    // constructor
    GxEPD2_122_GDEM0122T61(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
    // methods (virtual)
